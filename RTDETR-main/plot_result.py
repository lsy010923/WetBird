...
for i in names:
    data = pd.read_csv(f'runs/train/{i}/results.csv')
    data['        train/giou_loss'] = data['        train/giou_loss'].astype(np.float32).replace(np.inf, np.nan)
...
for i in names:
    data = pd.read_csv(f'runs/train/{i}/results.csv')
    data['          train/l1_loss'] = data['          train/l1_loss'].astype(np.float32).replace(np.inf, np.nan)
...
for i in names:
    data = pd.read_csv(f'runs/train/{i}/results.csv')
    data['          val/giou_loss'] = data['          val/giou_loss'].astype(np.float32).replace(np.inf, np.nan)
...
for i in names:
    data = pd.read_csv(f'runs/train/{i}/results.csv')
    data['            val/l1_loss'] = data['            val/l1_loss'].astype(np.float32).replace(np.inf, np.nan)
