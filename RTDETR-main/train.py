...
if __name__ == '__main__':
    model = RTDETR('/home/ssj/ccx/RTDETR-20250622/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-C2f-DIMB.yaml')
    ...
    model.train(data='/home/ssj/ccx/RTDETR-20250622/RTDETR-main/dataset/data.yaml',
                ...
                imgsz=640,
                epochs=200,
                batch=4, # batchsize 不建议乱动，一般来说4的效果是最好的，越大的batch效果会很差(经验之谈)
                workers=4, # Windows下出现莫名其妙卡主的情况可以尝试把workers设置为0
                # device='0,1', # 指定显卡和多卡训练参考<使用教程.md>下方常见错误和解决方案
                #resume='/home/ssj/ccx/RTDETR-20250622/RTDETR-main/runs/train/exp14/weights/last.pt', # last.pt path
                project='runs/train',
                name='exp',
                )