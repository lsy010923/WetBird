...
images_folder_path = ['/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/images/train',
                      '/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/images/val',
                      '/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/images/test']
labels_folder_path = ['/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/labels/train',
                      '/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/labels/val',
                      '/home/ssj/ccx/RTDETR-20250315/RTDETR-main/dataset/labels/test']
classes = ['Gallinula chloropus','Egretta garzetta','Anas zonorhyncha','Hydrophasianus chirurgus','Chlidonias hybrida','Charadrius dubius','Nycticorax nycticorax','Aredeola bacchus','Anas platyrhynchos','Tachybaptus ruficollis']
    ...
    for label_path in tqdm.tqdm(image_label_dict):
        ...
        if visual_box:
            ...
            if image is None:
                print(RED + f'{image_path} read failure. skip.' + RESET)
                continue  # 跳过这个损坏的文件
            # 将图片也缩放到640x640，以确保可视化结果和计算的尺度一致
        ...
        for cls_id, x_c, y_c, width, height in label:
            ...
            if visual_box:
                ...
                image = draw_detections([x_min, y_min, x_max, y_max], classes[int(float(cls_id))],
                                        get_color_by_class(int(float(cls_id))), image)
...
if __name__ == '__main__':
    ...
    show_dataset_info(image_label_dict, visual_box=False)
