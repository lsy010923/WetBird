...
if __name__ == '__main__':
    model_path = '/home/ssj/ccx/RTDETR-20250622/RTDETR-main/runs/train/exp15/weights/best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data='/home/ssj/ccx/RTDETR-20250622/RTDETR-main/dataset/data.yaml',
